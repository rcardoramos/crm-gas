        ...
        {MOCK_PRODUCTS.map((prod) => (
          <div key={prod.id} className="bg-white border border-[#003223]/10 rounded-2xl p-4 shadow-[0_2px_10px_rgba(0,0,0,0.02)] flex items-center gap-4 group hover:-translate-y-0.5 transition-transform">
            ...
            <div className="flex-1">
              <h2 className="text-[15px] font-bold text-[#003223] leading-tight">{prod.name}</h2>
              <p className="text-[11px] text-[#003223]/60 mt-0.5 leading-snug">{prod.desc}</p>
              <div className="flex items-center justify-between mt-3">
                <span className="font-bold text-[#003223]">S/ {prod.price.toFixed(2)}</span>
