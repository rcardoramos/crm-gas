        ...
        <main className="flex-1 flex flex-col min-w-0 overflow-hidden bg-white">
          <header className="h-16 bg-white border-b border-zinc-200/60 flex items-center justify-between px-8">
            ...
            <div className="flex items-center space-x-4">
              ...
              <input type="text" placeholder="Buscar..." className="hidden md:block w-56 h-8 px-3 text-[13px] text-zinc-900 border border-zinc-200 rounded-md focus:outline-none focus:ring-1 focus:ring-zinc-400 placeholder:text-zinc-400 shadow-sm bg-white" />
            </div>
          </header>
